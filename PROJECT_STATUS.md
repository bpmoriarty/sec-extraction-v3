...
## ⏩ RESUME HERE (last updated: session 22, 2026-08-18)

**Two pipelines. One is finished and shipping; one is mid-build.**

| Workstream | State |
|---|---|
| **XBRL / BDC** (10-K, 10-Q) | **DONE and shipping. Data current through 2026-06-30** (session 22). 1,353 filings, C1–C11 validation, holdings, `semiliquid_bdc_dataset.xlsx`, and an 11-tab `holdings_marks_comparison.xlsx`. Touch for bug fixes and quarterly refreshes. |
...
- **Close every workbook in Excel first.** A lock makes the rebuild fail with `PermissionError`.
- **Back up the four .xlsx + three .csv deliverables first** and diff row counts after; a silent
...
- **Funds with non-Dec fiscal year-ends file late and skew the newest quarter.** At 2026-06-30,
  ...
  none). Their absence biases that quarter's cross-holder medians — see guard 3 below.
