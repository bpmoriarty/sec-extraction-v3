...
it. **Next: run the full 3,084-filing inventory** (~30–50 min; resumable via `--resume`,
per-file CSV flush) to confirm the gate corpus-wide and produce the multi-series list M2 needs.
